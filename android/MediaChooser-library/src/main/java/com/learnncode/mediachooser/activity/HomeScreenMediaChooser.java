...
public class HomeScreenMediaChooser extends AppCompatActivity implements ImageFragment.OnImageSelectedListener, VideoFragment.OnVideoSelectedListener {
    ...
    public final String IMAGE_BUCKET = "图片夹";
    public final String VIDEO_BUCKET = "视频夹";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isBucket) {
            ...
            if (getIntent() != null && (getIntent().getBooleanExtra("isFromBucket", false))) {
                ...
                mTitle.setText(MediaChooserConstants.TITLE);
    ...
    public void onImageSelected(int count) {
        ...
        if (tabLayout.getTabAt(index) != null) {
            if (count != 0) {
                tabLayout.getTabAt(index).setText(getResources().getString(R.string.images_tab) + "  " + count);
            } else {
                tabLayout.getTabAt(index).setText(getResources().getString(R.string.image));
            }
        }
    }
                        ...
                        if (fragment instanceof ImageFragment) {
                            ...
                            if (videoFragment != null) {
                                if (videoFragment.getSelectedVideoList() != null && videoFragment.getSelectedVideoList().size() > 0) {
                                   ...
                                   /* videoIntent.putStringArrayListExtra("posterlist", videoFragment
                                            .getSelectedVideoPotserList());*/
