...
public class VideoFragment extends Fragment implements OnScrollListener {
   ...
   // private ArrayList<String> mSelectedItemPosters = new ArrayList<String>();
        ...
        mVideoGridView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
               ...
               ImageView imageView = (ImageView) view.findViewById(R.id
                        .imageViewFromMediaChooserGridItemRowView);
                String posterurl=(String) imageView.getTag();
                ...
                if (!galleryModel.status) {
                    ...
                    if ((MediaChooserConstants.MAX_MEDIA_LIMIT<=MediaChooserConstants
                ...
                if (galleryModel.status) {
                 ...
                 //   mSelectedItemPosters.add(posterurl);

                    MediaChooserConstants.SELECTED_MEDIA_COUNT++;

                } else {
                    mSelectedItems.remove(galleryModel.url.toString().trim());
                   // mSelectedItemPosters.remove(posterurl);
                    MediaChooserConstants.SELECTED_MEDIA_COUNT--;
                }
                ...
                if (mCallback != null) {
                    ...
                    //intent.putStringArrayListExtra("posterlist", mSelectedItemPosters);
  ...
  /*  public ArrayList<String> getSelectedVideoPotserList() {
        return mSelectedItemPosters;
    }*/
