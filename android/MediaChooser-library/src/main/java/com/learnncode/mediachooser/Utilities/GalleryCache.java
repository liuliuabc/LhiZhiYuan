...
public class GalleryCache {
        ...
        if (bitmap != null) {
            ...
            if (!isScrolling && !mCurrentTasks.contains(imageKey)) {
                if (mainActivity instanceof VideoFragment) {
                    BitmapLoaderTask task = new BitmapLoaderTask(imageView,imageKey, (
    ...
    private class BitmapLoaderTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        public BitmapLoaderTask( ImageView imageView,String imageKey, GridViewAdapter adapter) {
            myimageView=imageView;
            mAdapter = adapter;
            mImageKey = imageKey;
        }

        public BitmapLoaderTask( ImageView imageView,String imageKey, BucketGridAdapter adapter) {
            myimageView=imageView;
        ...
        protected void onPostExecute(Bitmap param) {
            ...
            if (param != null) {
                myimageView.setImageBitmap(param);
                if (mAdapter != null) {
